...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnBrowse->Location = System::Drawing::Point(319, 10);
			...
			this->btnPathto->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			this->btnPathto->Location = System::Drawing::Point(319, 110);
			...
			this->lstBoxMutants->Items->AddRange(gcnew cli::array< System::Object^  >(6) {
				L"Gain", L"Sum", L"Sum2Product", L"Product2Sum",
					L"Remove Abs", L"Goto->From"
			});
			this->lstBoxMutants->Location = System::Drawing::Point(319, 39);
			this->lstBoxMutants->Name = L"lstBoxMutants";
			this->lstBoxMutants->Size = System::Drawing::Size(113, 64);
...
#pragma endregion
	private: System::Void btnMutate_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		for (int i = 0; i < lstBoxMutants->CheckedItems->Count; i++) {
			...
			//endNum = intToString(i);
			//mutateFiles(converted_pathFrm, (converted_pathTo + endNum), converted_currItem);
			//mutateFiles(converted_pathFrm, (converted_pathTo + converted_currItem + "\\" + endNum), converted_currItem);
			mutateFiles(converted_pathFrm, (converted_pathTo + "\\"+ converted_currItem), converted_currItem);
			//mutateFiles(converted_pathFrm, converted_pathTo, converted_currItem);
		}
		//mutateFiles(converted_pathFrm, converted_pathTo);
		//mutateFiles(converted_pathFrm, converted_pathTo, converted_currItem);
	}
